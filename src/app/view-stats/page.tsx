            ...
            sheets.map((sheet) => (
              ...
              >
                <div className="flex-1 min-w-0">
                  <p className="text-base sm:text-lg lg:text-xl font-semibold truncate" style={{ color: 'white' }}>
                    {sheet.title === "Cumulative Stats" ? sheet.title : `Practice: ${sheet.title}`}
                  </p>
                  <p className="text-xs sm:text-sm truncate" style={{ color: 'white', opacity: 0.7 }}>
                    Click to download PDF
                  </p>
                </div>
                <div className="ml-4 flex-shrink-0">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: 'white' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
